...
export function CategoryTabs({ categories }: { categories: WooCategory[] }) {
  return (
    ...
    >
      <div className="scroll-snap-x flex gap-4 overflow-x-auto pl-16 pr-4 py-2 text-[12.5px] font-semibold [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:container-page md:pl-10">
        <Link
          to="/"
